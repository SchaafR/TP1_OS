CC = cc
CFLAGS = -Wall -Wextra -pedantic -g -pthread -DTRACE
LDFLAGS = -lreadline
...
biceps_P3: biceps_P3.c creme_tp3_etape2.c gescom.c
	$(CC) $(CFLAGS) -o biceps_P3 biceps_P3.c creme_tp3_etape2.c gescom.c $(LDFLAGS)
clean:
